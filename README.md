    ...
    <section class="deko-grid" id="deko-grid">
      ...
      <article class="deko-card"
        ...
        <div class="deko-media">
          ...
          <img src="<span class="deko-tag">Spezial</span><img src="<img src="https://raw.githubusercontent.com/GalaxieCadeau/Coc-deko/main/Screenshot_20251108_213125_Google.jpg"
<img alt="Halloween Grabstein" style="display:block; margin:20px auto; width:220px; border-radius:12px; box-shadow:0 0 10px rgba(0,0,0,0.4);"/>
        </div>
        <div class="deko-body">
